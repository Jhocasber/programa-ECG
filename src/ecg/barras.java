...
public class barras extends JFrame{
	AreaPanel gra=new AreaPanel();
	static int valorconteo=200000;
	public static int[][] valores=new int[valorconteo+1][2];
	        ...
	        b.addActionListener(new ActionListener() {
	        	 public void actionPerformed(ActionEvent l) {
		                ...
		                try {
						    ...
						    settings.setPort("COM9");
						    settings.setBaudRate(Baud._115200);
						    settings.setMinDelayWrite(1);
						    Com com1 = new Com(settings);
						    
						    for(int j = 0; j <valorconteo; j++) {
						    	
						    	
							char entradaCom = com1.receiveSingleChar();
							//int entradaCom=com1.receiveSingleCharAsInteger();
							//System.out.println(entradaCom);
...
//								 
							...
							//grafica g= new grafica(tiempo,datos);
							//o.add(g);
							//panel.add(o);
							//o.repaint();
						    }
